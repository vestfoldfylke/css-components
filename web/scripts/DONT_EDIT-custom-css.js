...
/* NOTES 
keep it simple
variants are ok on colors, but should maybe be set as what they should be used for, too keep simple accessibile colors
...
if a background color is light enough, we can use colored font on it - but coloured font should be dark enough to be readable
if a background color is dark enough, we always use white font on it

font-color is black or white
...
button.secondary, a.button.secondary {
	...
	border-color: var(--on-secondary-background-color);
}

button.tertiary, a.button.tertiary {
	background-color: var(--tertiary-background-color);
	color: var(--on-tertiary-background-color);
	border-color: var(--on-tertiary-background-color);
}
...
button.secondary.filled, a.button.secondary.filled, .button-input.secondary > button {
	background-color: var(--secondary-color);
	color: var(--on-secondary-color);
}

button.tertiary.filled, a.button.tertiary.filled, .button-input.tertiary > button {
...
button.filled.secondary:hover, a.button.filled.secondary:hover, .button-input.secondary > button:hover {
	background-color: var(--secondary-color-80);
}

button.filled.tertiary:hover, a.button.filled.tertiary:hover, .button-input.tertiary > button:hover {
...
button.filled.secondary:active, a.button.filled.secondary:active, .button-input.secondary button:active {
	background-color: var(--secondary-color-90);
}

button.filled.tertiary:active, a.button.filled.tertiary:active, .button-input.tertiary button:active {
